...
# save the results
@save joinpath(@__DIR__, "../../results/models/Wang-Kuramoto.jld2") result_neuralode2
JLD2.@load joinpath(@__DIR__, "../../results/models/Wang-Kuramoto.jld2") result_neuralode_load
